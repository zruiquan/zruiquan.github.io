...
![image-20241026230823913](电商数仓项目-电商数据仓库系统4/image-20241026230823913.png)

![image-20241026233132338](电商数仓项目-电商数据仓库系统4/image-20241026233132338.png)

![image-20241026233742192](电商数仓项目-电商数据仓库系统4/image-20241026233742192.png)

**（2）第一范式**

![image-20241026230921541](电商数仓项目-电商数据仓库系统4/image-20241026230921541.png)

![image-20241026233806897](电商数仓项目-电商数据仓库系统4/image-20241026233806897.png)

**（3）第二范式**

![image-20241026231000171](电商数仓项目-电商数据仓库系统4/image-20241026231000171.png)

![image-20241026233845224](电商数仓项目-电商数据仓库系统4/image-20241026233845224.png)

**（4）第三范式**

![image-20241026231034750](电商数仓项目-电商数据仓库系统4/image-20241026231034750.png)

![image-20241026233900833](电商数仓项目-电商数据仓库系统4/image-20241026233900833.png)
...
![image-20241026231857541](电商数仓项目-电商数据仓库系统4/image-20241026231857541.png)

![image-20241026231910823](电商数仓项目-电商数据仓库系统4/image-20241026231910823.png)

![image-20241026231958790](电商数仓项目-电商数据仓库系统4/image-20241026231958790.png)

示例：统计2022年下半年各个省份的订单销售总额

![image-20241026234207229](电商数仓项目-电商数据仓库系统4/image-20241026234207229.png)
...
![image-20241026231142268](电商数仓项目-电商数据仓库系统4/image-20241026231142268.png)
...
![image-20241026231337618](电商数仓项目-电商数据仓库系统4/image-20241026231337618.png)
...
![image-20241026235522142](电商数仓项目-电商数据仓库系统4/image-20241026235522142.png)
...
![image-20241026235621938](电商数仓项目-电商数据仓库系统4/image-20241026235621938.png)

![image-20241026235641756](电商数仓项目-电商数据仓库系统4/image-20241026235641756.png)

![image-20241026235714691](电商数仓项目-电商数据仓库系统4/image-20241026235714691.png)

## 5.2 数据仓库构建流程

以下是构建数据仓库的完整流程。

![image-20241027002038717](电商数仓项目-电商数据仓库系统4/image-20241027002038717.png)
...
![image-20241027002121064](电商数仓项目-电商数据仓库系统4/image-20241027002121064.png)
...
![image-20241027002328336](电商数仓项目-电商数据仓库系统4/image-20241027002328336.png)
...
![image-20241027002609132](电商数仓项目-电商数据仓库系统4/image-20241027002609132.png)
...
![image-20241027010100506](电商数仓项目-电商数据仓库系统4/image-20241027010100506.png)
...
![image-20241027010241929](电商数仓项目-电商数据仓库系统4/image-20241027010241929.png)
...
![image-20241027213321730](电商数仓项目-电商数据仓库系统4/image-20241027213321730.png)
...
![image-20241028155856821](电商数仓项目-电商数据仓库系统4/image-20241028155856821.png)
...
一般来说编码和名称共存，因为最终统计获取的如果只是编码就不能知道该编码代表的含义，所以需要加上名称字段。
...
1. 分区规划
   ...
   ![image-20241029151422058](电商数仓项目-电商数据仓库系统4/image-20241029151422058.png)

2. 数据流向

   ![image-20241029151434263](电商数仓项目-电商数据仓库系统4/image-20241029151434263.png)

3. 数据装载

   ![image-20241029151645092](电商数仓项目-电商数据仓库系统4/image-20241029151645092.png)

   ![image-20241029151715352](电商数仓项目-电商数据仓库系统4/image-20241029151715352.png)

   ![image-20241029151734306](电商数仓项目-电商数据仓库系统4/image-20241029151734306.png)
...
![image-20241029175353350](电商数仓项目-电商数据仓库系统4/image-20241029175353350.png)
...
1. 从ods_coupon_info_full表中筛选2022-06-08分区的数据，选取需要的字段，如优惠券名称、优惠券类型、使用条件等。

2. 将①中获取的数据与ods_base_dic_full关联获取优惠券类型名称和优惠范围类型名称。关联字段分别为优惠券类型和优惠范围类型，这两种编码在字典表中一定有对应记录，而字典表中其它编码对应记录对我们是没有意义的，因此以ods_coupon_info_full作为主表，应使用内连接或左外连接。

3. 通过case when… then… end语法根据不同的优惠券类型，生成不同的优惠规则字符串，记为benefit_rule字段。

4. 最终，将查询结果覆盖写入dim_coupon_full的2022-06-08分区。
...
3. 数据装载
   ...
   ![image-20241030100516837](电商数仓项目-电商数据仓库系统4/image-20241030100516837.png)
...
![image-20241030100155584](电商数仓项目-电商数据仓库系统4/image-20241030100155584.png)
...
1. 从ods_activity_rule_full表中筛选2022-06-08分区的数据，并选取需要的字段，子查询记为rule。

2. 从ods_activity_info_full 表中筛选2022-06-08分区的数据，并选取需要的字段，子查询记为info。

3. 筛选字典表2022-06-08分区的数据。

4. 以rule作为主表，通过activity_id关联info。活动规则和活动信息的每一条数据都可以在另一张表中找到对应记录，因此inner join、left join、right join、full outer join都是等价的，任选一种即可。此处选择left join。

5. 与8.2同理，关联字段表获取编码名称字段选择left join。

6. 筛选字段，写入dim_activity_full的2022-06-08分区。
...
3. 数据装载
   ...
   ![image-20241030100751026](电商数仓项目-电商数据仓库系统4/image-20241030100751026.png)
...
1. 筛选ods_base_province_full表2022-06-08分区的数据，选取所须字段，子查询记为province。

2. 筛选ods_base_region_full表2022-06-08分区的数据，选取所须字段，子查询记为region。

3. 通过region_id将province和region关联起来。两张表不存在不满足关联条件的数据，inner join、left join、right join、full outer join都是一样的，此处选用left join。

4. 选取所须字段，写入dim_province_full表的2022-06-08分区。
...
3. 数据装载
   ...
   ![image-20241030103708179](电商数仓项目-电商数据仓库系统4/image-20241030103708179.png)
...
```properties
2022-01-01	1	6	1	1	1	2022	0	元旦
2022-01-02	1	7	2	1	1	2022	0	元旦
2022-01-03	2	1	3	1	1	2022	0	元旦
2022-01-04	2	2	4	1	1	2022	1	\N
2022-01-05	2	3	5	1	1	2022	1	\N
2022-01-06	2	4	6	1	1	2022	1	\N
2022-01-07	2	5	7	1	1	2022	1	\N
2022-01-08	2	6	8	1	1	2022	0	\N
2022-01-09	2	7	9	1	1	2022	0	\N
2022-01-10	3	1	10	1	1	2022	1	\N
2022-01-11	3	2	11	1	1	2022	1	\N
2022-01-12	3	3	12	1	1	2022	1	\N
2022-01-13	3	4	13	1	1	2022	1	\N
2022-01-14	3	5	14	1	1	2022	1	\N
2022-01-15	3	6	15	1	1	2022	0	\N
2022-01-16	3	7	16	1	1	2022	0	\N
2022-01-17	4	1	17	1	1	2022	1	\N
2022-01-18	4	2	18	1	1	2022	1	\N
2022-01-19	4	3	19	1	1	2022	1	\N
2022-01-20	4	4	20	1	1	2022	1	\N
2022-01-21	4	5	21	1	1	2022	1	\N
2022-01-22	4	6	22	1	1	2022	0	\N
2022-01-23	4	7	23	1	1	2022	0	\N
2022-01-24	5	1	24	1	1	2022	1	\N
2022-01-25	5	2	25	1	1	2022	1	\N
2022-01-26	5	3	26	1	1	2022	1	\N
2022-01-27	5	4	27	1	1	2022	1	\N
2022-01-28	5	5	28	1	1	2022	1	\N
2022-01-29	5	6	29	1	1	2022	1	\N
2022-01-30	5	7	30	1	1	2022	1	\N
2022-01-31	6	1	31	1	1	2022	0	春节
2022-02-01	6	2	1	2	1	2022	0	春节
2022-02-02	6	3	2	2	1	2022	0	春节
2022-02-03	6	4	3	2	1	2022	0	春节
2022-02-04	6	5	4	2	1	2022	0	春节
2022-02-05	6	6	5	2	1	2022	0	春节
2022-02-06	6	7	6	2	1	2022	0	春节
2022-02-07	7	1	7	2	1	2022	1	\N
... ...
```
...
![image-20241030160608259](电商数仓项目-电商数据仓库系统4/image-20241030160608259.png)

![image-20241030180616089](电商数仓项目-电商数据仓库系统4/image-20241030180616089.png)

![image-20241030224739664](电商数仓项目-电商数据仓库系统4/image-20241030224739664.png)

![image-20241030230122292](电商数仓项目-电商数据仓库系统4/image-20241030230122292.png)

![image-20241030230837243](电商数仓项目-电商数据仓库系统4/image-20241030230837243.png)

![image-20241030231115407](电商数仓项目-电商数据仓库系统4/image-20241030231115407.png)

![image-20241030232619460](电商数仓项目-电商数据仓库系统4/image-20241030232619460.png)

![image-20241030233736069](电商数仓项目-电商数据仓库系统4/image-20241030233736069.png)

因为首日全量数据都有效，所以都放在最新状态的日期分区，也就是结束日期所在的分区里面。

并且第二种分区策略可以简化查询的操作，能精确根据分区查出最新数据和历史数据，而通过第一种方式则不能。

上面的首日全量数据到拉链表的过程分析是：

1. 保存到开始日期的分区

   zhangsan 20  2022-06-08 9999-12-31 => 2022-06-08

   lisi            18  2022-06-08 9999-12-31 => 2022-06-08 

   其中lisi在2022-06-09进行了修改，则保存到 2022-06-09 分区

   lisi            19  2022-06-09 9999-12-31 => 2022-06-09

   并且旧的数据的结束时间要进行调整

   lisi            18  2022-06-08  2022-06-08 => 2022-06-08 
...
1. 保存到结束日期的分区
   ...
   zhangsan 20  2022-06-08 9999-12-31 => 9999-12-31

   lisi            18  2022-06-08 9999-12-31 => 9999-12-31

   其中lisi在2022-06-09进行了修改，则保存到 9999-12-31 分区

   lisi            19  2022-06-09 9999-12-31 => 9999-12-31

   并且旧的数据的结束时间要进行调整，并且存放的分区也要进行调整
...
![image-20241030234650106](电商数仓项目-电商数据仓库系统4/image-20241030234650106.png)

分析：假如今天新增了数据，则start、end、partition遵循和首日全量数据一样的逻辑，但是假如今天（2022-06-09）对昨天的数据（2022-06-08）进行了修改，则修改后的数据也遵循和首日全量数据一样的逻辑，但是对修改前的数据（都在9999-12-31最新状态分区中）要修改结束时间为昨天的2022-06-08，且partition也修改为2022-06-08

每日增量数据到拉链表是采用动态分区的方式，因为此时需要根据不同标记更新覆盖最新状态分区9999-12-31分区的数据和更新覆盖历史分区的数据。

![image-20241031113800602](电商数仓项目-电商数据仓库系统4/image-20241031113800602.png)

![image-20241031105943661](电商数仓项目-电商数据仓库系统4/image-20241031105943661.png)

**比对方式：**

![image-20241031114129439](电商数仓项目-电商数据仓库系统4/image-20241031114129439.png)

上面使用的是union方式，现在分析join方式

![image-20241031144054199](电商数仓项目-电商数据仓库系统4/image-20241031144054199.png)

一共六条，full join之后还少一条，所以还需要再inner join 一下。所以这种方式不太推荐，因为比较复杂，效率不高。
...
1. regexp：用法：A regexp B，AB均为字符串，A是待匹配的字符串，B是正则表达式。若A、B其中之一为null则返回false。若A中的任意子串可以匹配B则返回true，否则返回false。如果要让整个A串与B匹配才返回true，需要在B中通过^和$限定A开头和结尾的字符。
...
1. 分区规划
   ...
   ![image-20241030170441861](电商数仓项目-电商数据仓库系统4/image-20241030170441861.png)

2. 数据流向

   ![image-20241030170455732](电商数仓项目-电商数据仓库系统4/image-20241030170455732.png)

3. 数据装载

   ![image-20241030170530045](电商数仓项目-电商数据仓库系统4/image-20241030170530045.png)

   ![image-20241030170609366](电商数仓项目-电商数据仓库系统4/image-20241030170609366.png)
...
![image-20241101113940508](电商数仓项目-电商数据仓库系统4/image-20241101113940508.png)

![image-20241101144118609](电商数仓项目-电商数据仓库系统4/image-20241101144118609.png)

![image-20241101144409198](电商数仓项目-电商数据仓库系统4/image-20241101144409198.png)

![image-20241101144602393](电商数仓项目-电商数据仓库系统4/image-20241101144602393.png)

![image-20241101150154499](电商数仓项目-电商数据仓库系统4/image-20241101150154499.png)

表字段来源：熟悉业务数据库该事实行为的表关联关系，挑选关联关系中数据发生增量变化的表，数据量不变的表不挑选，然后从对应的ods层获取。
...
![image-20241101164636760](电商数仓项目-电商数据仓库系统4/image-20241101164636760.png)

![image-20241103022247226](电商数仓项目-电商数据仓库系统4/image-20241103022247226.png)

![image-20241103023408376](电商数仓项目-电商数据仓库系统4/image-20241103023408376.png)

![image-20241103023519971](电商数仓项目-电商数据仓库系统4/image-20241103023519971.png)

![image-20241103023425098](电商数仓项目-电商数据仓库系统4/image-20241103023425098.png)

![image-20241103025208551](电商数仓项目-电商数据仓库系统4/image-20241103025208551.png)

![image-20241103025229762](电商数仓项目-电商数据仓库系统4/image-20241103025229762.png)

首日采用动态分区。

![image-20241103205553300](电商数仓项目-电商数据仓库系统4/image-20241103205553300.png)
...
1. 分区规划
   ...
   ![image-20241104102655484](电商数仓项目-电商数据仓库系统4/image-20241104102655484.png)

2. 数据流向

   ![image-20241104102732928](电商数仓项目-电商数据仓库系统4/image-20241104102732928.png)
...
![image-20241104104342136](电商数仓项目-电商数据仓库系统4/image-20241104104342136.png)
...
3. 数据装载
   ...
   ![image-20241104144320965](电商数仓项目-电商数据仓库系统4/image-20241104144320965.png)
...
![image-20241104160831748](电商数仓项目-电商数据仓库系统4/image-20241104160831748.png)

这里支付是对订单支付，商品列可以不要就可以描述支付成功的行为，但是为了最细粒度，和更广泛的统计需求，这里加上。
...
3. 数据装载
   ...
   ![image-20241104162105427](电商数仓项目-电商数据仓库系统4/image-20241104162105427.png)

   ![image-20241104162118132](电商数仓项目-电商数据仓库系统4/image-20241104162118132.png)

   ![image-20241104162129399](电商数仓项目-电商数据仓库系统4/image-20241104162129399.png)
...
![image-20241104230620464](电商数仓项目-电商数据仓库系统4/image-20241104230620464.png)

![image-20241104230647410](电商数仓项目-电商数据仓库系统4/image-20241104230647410.png)

![image-20241104230747814](电商数仓项目-电商数据仓库系统4/image-20241104230747814.png)

![image-20241104231718949](电商数仓项目-电商数据仓库系统4/image-20241104231718949.png)
...
1. 分区规划
   ...
   ![image-20241104232759508](电商数仓项目-电商数据仓库系统4/image-20241104232759508.png)

2. 数据流向

   ![image-20241104232824092](电商数仓项目-电商数据仓库系统4/image-20241104232824092.png)
...
![image-20241105154638847](电商数仓项目-电商数据仓库系统4/image-20241105154638847.png)

![image-20241105212517120](电商数仓项目-电商数据仓库系统4/image-20241105212517120.png)

![image-20241105212538780](电商数仓项目-电商数据仓库系统4/image-20241105212538780.png)

![image-20241105213455133](电商数仓项目-电商数据仓库系统4/image-20241105213455133.png)

![image-20241105213611947](电商数仓项目-电商数据仓库系统4/image-20241105213611947.png)

![image-20241105222223869](电商数仓项目-电商数据仓库系统4/image-20241105222223869.png)
...
1. 分区规划
   ...
   ![image-20241105231909673](电商数仓项目-电商数据仓库系统4/image-20241105231909673.png)

2. 数据流向

   ![image-20241105232027657](电商数仓项目-电商数据仓库系统4/image-20241105232027657.png)

3. 数据装载

   ![image-20241105232047135](电商数仓项目-电商数据仓库系统4/image-20241105232047135.png)

   ![image-20241105232112449](电商数仓项目-电商数据仓库系统4/image-20241105232112449.png)

   ![image-20241105232132447](电商数仓项目-电商数据仓库系统4/image-20241105232132447.png)
...
![image-20241106233741545](电商数仓项目-电商数据仓库系统4/image-20241106233741545.png)
...
![image-20241109204505049](电商数仓项目-电商数据仓库系统4/image-20241109204505049.png)
...
![image-20241109213239743](电商数仓项目-电商数据仓库系统4/image-20241109213239743.png)
...
1. 分区规划
   ...
   ![image-20241109233441225](电商数仓项目-电商数据仓库系统4/image-20241109233441225.png)

2. 数据流向

   ![image-20241109233504896](电商数仓项目-电商数据仓库系统4/image-20241109233504896.png)
...
![image-20241109235905496](电商数仓项目-电商数据仓库系统4/image-20241109235905496.png)

![image-20241111221326942](电商数仓项目-电商数据仓库系统4/image-20241111221326942.png)
...
1. 分区规划
   ...
   ![image-20241110020043426](电商数仓项目-电商数据仓库系统4/image-20241110020043426.png)

2. 数据流向

   ![image-20241110020148953](电商数仓项目-电商数据仓库系统4/image-20241110020148953.png)

3. 数据装载

   ![image-20241110020200895](电商数仓项目-电商数据仓库系统4/image-20241110020200895.png)
...
![image-20241110020757258](电商数仓项目-电商数据仓库系统4/image-20241110020757258.png)

![image-20241111221028914](电商数仓项目-电商数据仓库系统4/image-20241111221028914.png)
...
1. 筛选当日分区page字段不为null的数据，且user_id不为null的数据，获取用户处于登录状态的页面日志。开窗，按照会话ID（common.sid）分区，ts升序排列，调用row_number()为每条数据编号，记为rn，选取ts、user_id及其它感兴趣的字段，记为t1子查询。

2. 从t1子查询中筛选rn为1的数据，即每个会话首个user_id不为null的页面浏览记录，对应登录操作，选取所须字段，记为t2子查询。

3. 根据t2子查询中的ts字段生成登录日期和登录时间字段，与其它感兴趣的字段一并写入当日分区。
...
3. 数据装载
   ...
   ![image-20241110024226407](电商数仓项目-电商数据仓库系统4/image-20241110024226407.png)

   ![image-20241110024238718](电商数仓项目-电商数据仓库系统4/image-20241110024238718.png)

   ![image-20241110024249552](电商数仓项目-电商数据仓库系统4/image-20241110024249552.png)
...
![image-20241111220444689](电商数仓项目-电商数据仓库系统4/image-20241111220444689.png)

![image-20241111220550081](电商数仓项目-电商数据仓库系统4/image-20241111220550081.png)

![image-20241111220645569](电商数仓项目-电商数据仓库系统4/image-20241111220645569.png)

### 9.11.4 练习

![image-20241112004628340](电商数仓项目-电商数据仓库系统4/image-20241112004628340.png)

![image-20241112004650345](电商数仓项目-电商数据仓库系统4/image-20241112004650345.png)

# 第10章 数仓开发之DWS层

![image-20241123171330207](电商数仓项目-电商数据仓库系统4/image-20241123171330207.png)

![image-20241123175438667](电商数仓项目-电商数据仓库系统4/image-20241123175438667.png)

![image-20241123175535592](电商数仓项目-电商数据仓库系统4/image-20241123175535592.png)

如果想将多个统计值汇总到一个dws统计中间表中，则需要满足上述条件，所以表的命名也是按照这种方式去做。

![image-20241123160712549](电商数仓项目-电商数据仓库系统4/image-20241123160712549.png)

![image-20241123162406819](电商数仓项目-电商数据仓库系统4/image-20241123162406819.png)
...
注：1d表示最近1日，nd表示最近n日，td表示历史至今。区别其实就是统计时间范围的不同，根据统计时间范围的不同进行有选择的创建。

**此层没有具体的设计理论，全靠能力和经验，体现个人能力的强与弱，此层主要目的是减少重复计算，主要是参考ads层进行设计，所以dws层的设计依托于ads层的设计，做一些规划和简化，便于我们进行预聚合计算，所以dws层的表的设计依托于ads层的设计，并符合预聚合的设计理念，便于简化后续处理分析。**

## 10.1 最近1日汇总表

### 10.1.1 交易域用户商品粒度订单最近1日汇总表

![image-20241123204304495](电商数仓项目-电商数据仓库系统4/image-20241123204304495.png)

![image-20241123211617009](电商数仓项目-电商数据仓库系统4/image-20241123211617009.png)

![image-20241123220305619](电商数仓项目-电商数据仓库系统4/image-20241123220305619.png)
...
1. 分区规划
   ...
   ![image-20241123212953299](电商数仓项目-电商数据仓库系统4/image-20241123212953299.png)

2. 数据流向

   ![image-20241123213036158](电商数仓项目-电商数据仓库系统4/image-20241123213036158.png)

3. 数据装载

   ![image-20241123213717961](电商数仓项目-电商数据仓库系统4/image-20241123213717961.png)

   ![image-20241123213727794](电商数仓项目-电商数据仓库系统4/image-20241123213727794.png)

   ![image-20241123213744107](电商数仓项目-电商数据仓库系统4/image-20241123213744107.png)
...
![image-20241123225319854](电商数仓项目-电商数据仓库系统4/image-20241123225319854.png)
...
![image-20241124015136718](电商数仓项目-电商数据仓库系统4/image-20241124015136718.png)

![image-20241124015151216](电商数仓项目-电商数据仓库系统4/image-20241124015151216.png)

![image-20241124015158844](电商数仓项目-电商数据仓库系统4/image-20241124015158844.png)
...
1. 分区规划
   ...
   ![image-20241124031207812](电商数仓项目-电商数据仓库系统4/image-20241124031207812.png)

2. 数据流向

   ![image-20241124031224601](电商数仓项目-电商数据仓库系统4/image-20241124031224601.png)
...
![image-20241123221824820](电商数仓项目-电商数据仓库系统4/image-20241123221824820.png)

![image-20241123223157502](电商数仓项目-电商数据仓库系统4/image-20241123223157502.png)
...
1. 分区规划
   ...
   ![image-20241123223720693](电商数仓项目-电商数据仓库系统4/image-20241123223720693.png)

2. 数据流向

   ![image-20241123223737325](电商数仓项目-电商数据仓库系统4/image-20241123223737325.png)
...
![image-20241124001613130](电商数仓项目-电商数据仓库系统4/image-20241124001613130.png)

![image-20241124003449542](电商数仓项目-电商数据仓库系统4/image-20241124003449542.png)

注意：这里可以直接用统计粒度相同，业务行为相同的dws层1d表直接拿来用，可以不用dwd层的表，这个可以根据实际情况确定，在ads层的新增下单用户统计和下一个 用户域用户粒度登录历史至今汇总表 ，我们就是用的dwd层数据直接进行统计生成的dws表
...
1. 分区规划
   ...
   ![image-20241124005222237](电商数仓项目-电商数据仓库系统4/image-20241124005222237.png)

2. 数据流向

   ![image-20241124005250053](电商数仓项目-电商数据仓库系统4/image-20241124005250053.png)

3. 数据装载

   ![image-20241124005303191](电商数仓项目-电商数据仓库系统4/image-20241124005303191.png)

   ![image-20241124005313505](电商数仓项目-电商数据仓库系统4/image-20241124005313505.png)
...
![image-20241124034201403](电商数仓项目-电商数据仓库系统4/image-20241124034201403.png)
...
1. 分区规划
   ...
   ![image-20241124043325146](电商数仓项目-电商数据仓库系统4/image-20241124043325146.png)

2. 数据流向

   ![image-20241124043431158](电商数仓项目-电商数据仓库系统4/image-20241124043431158.png)

3. 数据装载

a）首日装载

![image-20241124043603643](电商数仓项目-电商数据仓库系统4/image-20241124043603643.png)

![image-20241124043610381](电商数仓项目-电商数据仓库系统4/image-20241124043610381.png)

b）每日装载

![image-20241124043542935](电商数仓项目-电商数据仓库系统4/image-20241124043542935.png)

![image-20241124043552627](电商数仓项目-电商数据仓库系统4/image-20241124043552627.png)
...
![image-20241112001634434](电商数仓项目-电商数据仓库系统4/image-20241112001634434.png)

![image-20241112003901841](电商数仓项目-电商数据仓库系统4/image-20241112003901841.png)

![image-20241113213956596](电商数仓项目-电商数据仓库系统4/image-20241113213956596.png)

注意：上图是对最终ADS层统计结果表字段的分析，对应下图的需求分析（其实是对应DWS的派生指标的，应该汇总到DWS层，只不过这里为了简单是直接汇总到ADS层了，应该是为了方便和简单才这样去做，因为一张汇总表通常包含业务过程相同、统计周期相同、统计粒度相同的多个派生指标，这里不考虑复用性和重复计算问题，直接保存到ADS层）。另外这个例子也缺少派生指标中的业务限定。

![image-20241114001527598](电商数仓项目-电商数据仓库系统4/image-20241114001527598.png)

最终我们得到建表语句，如下图

![image-20241113214123409](电商数仓项目-电商数据仓库系统4/image-20241113214123409.png)

![image-20241113222613793](电商数仓项目-电商数据仓库系统4/image-20241113222613793.png)

![image-20241113225309288](电商数仓项目-电商数据仓库系统4/image-20241113225309288.png)

上图就完成了最基础的原子指标的装载，我们只是为了好理解进行了简化，将我们复杂的统计指标先分解成最基础的原子指标，后面逐渐叠加补充完整直到得到我们想要的指标。

![image-20241113233551971](电商数仓项目-电商数据仓库系统4/image-20241113233551971.png)

```
select 
	count(distinct order_id) -- 原子指标
from dwd_trade_order_detail_inc
where dt >=data_sub('2022-06-08',0) and dt <= '2022-06-08' -- 统计周期
and catrgory='生活用品' -- 业务限定
group by '品牌' -- 统计粒度（分析数据的具体角度）
```

上述SQL就是基于原子指标对派生指标进行的补全，派生指标通常会对应实际的统计需求，派生指标对应DWS层数据。

上述的例子通过分析得到的派生指标一般保存在DWS层，然后再过渡到ADS层但是这里是直接保存到ADS层，应该是为了方便和简单才这样去做，因为一张汇总表通常包含业务过程相同、统计周期相同、统计粒度相同的多个派生指标，这里不考虑复用性和重复计算问题，直接保存到ADS层。另外这个例子也缺少派生指标中的业务限定，上面SQL为了方便理解我模拟了一个业务限定。

![image-20241113235309077](电商数仓项目-电商数据仓库系统4/image-20241113235309077.png)

**指标体系总结：**

![image-20241113234541659](电商数仓项目-电商数据仓库系统4/image-20241113234541659.png)

![image-20241113235326829](电商数仓项目-电商数据仓库系统4/image-20241113235326829.png)

**粒度减少总结：**

![image-20241123233151287](电商数仓项目-电商数据仓库系统4/image-20241123233151287.png)

![image-20241123233402519](电商数仓项目-电商数据仓库系统4/image-20241123233402519.png)

![image-20241123233602935](电商数仓项目-电商数据仓库系统4/image-20241123233602935.png)

![image-20241123234439560](电商数仓项目-电商数据仓库系统4/image-20241123234439560.png)

如果粒度变成了user + tm ，这属于粒度变粗，也是属于粒度发生变化的一种，需要对其他字段也需要进一步的统计，需要聚合数据。

![image-20241123234527691](电商数仓项目-电商数据仓库系统4/image-20241123234527691.png)

## 11.1 流量主题

### 11.1.1 各渠道流量统计

![image-20241127180525566](电商数仓项目-电商数据仓库系统4/image-20241127180525566.png)
...
![image-20241128003628173](电商数仓项目-电商数据仓库系统4/image-20241128003628173.png)

![image-20241128013837039](电商数仓项目-电商数据仓库系统4/image-20241128013837039.png)

![image-20241128013800390](电商数仓项目-电商数据仓库系统4/image-20241128013800390.png)
...
![image-20241128014542319](电商数仓项目-电商数据仓库系统4/image-20241128014542319.png)

![image-20241128014602002](电商数仓项目-电商数据仓库系统4/image-20241128014602002.png)
...
![image-20241128030506444](电商数仓项目-电商数据仓库系统4/image-20241128030506444.png)

![image-20241128035450489](电商数仓项目-电商数据仓库系统4/image-20241128035450489.png)
...
![image-20241128180052287](电商数仓项目-电商数据仓库系统4/image-20241128180052287.png)

![image-20241128180823219](电商数仓项目-电商数据仓库系统4/image-20241128180823219.png)

![image-20241128180955372](电商数仓项目-电商数据仓库系统4/image-20241128180955372.png)
...
![image-20241128193140960](电商数仓项目-电商数据仓库系统4/image-20241128193140960.png)
...
![image-20241128215449124](电商数仓项目-电商数据仓库系统4/image-20241128215449124.png)
...
![image-20241121230728311](电商数仓项目-电商数据仓库系统4/image-20241121230728311.png)
...
![image-20241122012707567](电商数仓项目-电商数据仓库系统4/image-20241122012707567.png)

![image-20241121225856272](电商数仓项目-电商数据仓库系统4/image-20241121225856272.png)

![image-20241121230135761](电商数仓项目-电商数据仓库系统4/image-20241121230135761.png)

每日

![image-20241121230250106](电商数仓项目-电商数据仓库系统4/image-20241121230250106.png)

所以最终解决SQL为：

![image-20241122013809236](电商数仓项目-电商数据仓库系统4/image-20241122013809236.png)

![image-20241122013640589](电商数仓项目-电商数据仓库系统4/image-20241122013640589.png)

![image-20241122013716983](电商数仓项目-电商数据仓库系统4/image-20241122013716983.png)

![image-20241122014049265](电商数仓项目-电商数据仓库系统4/image-20241122014049265.png)

![image-20241122014136178](电商数仓项目-电商数据仓库系统4/image-20241122014136178.png)

![image-20241122014446117](电商数仓项目-电商数据仓库系统4/image-20241122014446117.png)

![image-20241122014459461](电商数仓项目-电商数据仓库系统4/image-20241122014459461.png)
...
![image-20241129005034182](电商数仓项目-电商数据仓库系统4/image-20241129005034182.png)

![image-20241129005153504](电商数仓项目-电商数据仓库系统4/image-20241129005153504.png)

![image-20241129005217754](电商数仓项目-电商数据仓库系统4/image-20241129005217754.png)
...
![image-20241129011513812](电商数仓项目-电商数据仓库系统4/image-20241129011513812.png)

![image-20241129011526675](电商数仓项目-电商数据仓库系统4/image-20241129011526675.png)
...
![image-20241129014952268](电商数仓项目-电商数据仓库系统4/image-20241129014952268.png)

![image-20241129022240608](电商数仓项目-电商数据仓库系统4/image-20241129022240608.png)

统计粒度发生变化，需要去重，具体参考ads开头的笔记

![image-20241129030640414](电商数仓项目-电商数据仓库系统4/image-20241129030640414.png)

![image-20241129030714507](电商数仓项目-电商数据仓库系统4/image-20241129030714507.png)
...
**此需求前置分析步骤请参阅本章开头的笔记分析内容**

![image-20241122021802606](电商数仓项目-电商数据仓库系统4/image-20241122021802606.png)

![image-20241116222134176](电商数仓项目-电商数据仓库系统4/image-20241116222134176.png)

![image-20241116224206253](电商数仓项目-电商数据仓库系统4/image-20241116224206253.png)

![image-20241117023811946](电商数仓项目-电商数据仓库系统4/image-20241117023811946.png)

上述初步得到数据装载的SQL，具体分析可参考电商数仓6.0第158集

![image-20241117020820307](电商数仓项目-电商数据仓库系统4/image-20241117020820307.png)

![image-20241117021320798](电商数仓项目-电商数据仓库系统4/image-20241117021320798.png)

![image-20241117021420785](电商数仓项目-电商数据仓库系统4/image-20241117021420785.png)

通过上述分析可知，我们可以通过**减少重复计算**和**减少重复读取**以提高效率。

**减少重复计算**

需要一个中间表存储每天预聚合的数据，为后面的进一步分析做准备，所以需要创建预聚合的数据表，其实也就是DWS层的预聚合表，用于后面进一步分析。

![image-20241117022734764](电商数仓项目-电商数据仓库系统4/image-20241117022734764.png)

![image-20241117022818263](电商数仓项目-电商数据仓库系统4/image-20241117022818263.png)

所以dws层的设计依托于ads层的设计，做一些规划和简化，便于我们进行预聚合计算，所以dws层的表的设计依托于ads层的设计，并符合预聚合的设计理念，便于简化后续处理分析。

![image-20241117023048593](电商数仓项目-电商数据仓库系统4/image-20241117023048593.png)

![image-20241117023118605](电商数仓项目-电商数据仓库系统4/image-20241117023118605.png)

新的数据装载SQL如下

![image-20241117024833249](电商数仓项目-电商数据仓库系统4/image-20241117024833249.png)

上述得到数据装载的SQL，具体分析可参考电商数仓6.0第159集

**减少重复读取**

上述SQL还可以进一步优化

![image-20241118221026483](电商数仓项目-电商数据仓库系统4/image-20241118221026483.png)

![image-20241118220029223](电商数仓项目-电商数据仓库系统4/image-20241118220029223.png)

![image-20241118222255521](电商数仓项目-电商数据仓库系统4/image-20241118222255521.png)

![image-20241118221812704](电商数仓项目-电商数据仓库系统4/image-20241118221812704.png)

![image-20241118222336965](电商数仓项目-电商数据仓库系统4/image-20241118222336965.png)

上述炸裂之后要记录标记，代表数据不同的用途

![image-20241118222433493](电商数仓项目-电商数据仓库系统4/image-20241118222433493.png)

![image-20241118222449067](电商数仓项目-电商数据仓库系统4/image-20241118222449067.png)

![image-20241118222501998](电商数仓项目-电商数据仓库系统4/image-20241118222501998.png)

![image-20241118222855562](电商数仓项目-电商数据仓库系统4/image-20241118222855562.png)

![image-20241118223720253](电商数仓项目-电商数据仓库系统4/image-20241118223720253.png)

上述得到数据装载的SQL，具体分析可参考电商数仓6.0第160集

**其他思路**

除了上述方式之外，我们还可以有其他思路，例如**基于1d表创建nd表**

![image-20241119000423821](电商数仓项目-电商数据仓库系统4/image-20241119000423821.png)

![image-20241119000519500](电商数仓项目-电商数据仓库系统4/image-20241119000519500.png)

![image-20241119000735044](电商数仓项目-电商数据仓库系统4/image-20241119000735044.png)

![image-20241119000717127](电商数仓项目-电商数据仓库系统4/image-20241119000717127.png)

![image-20241119000801554](电商数仓项目-电商数据仓库系统4/image-20241119000801554.png)

![image-20241119000822948](电商数仓项目-电商数据仓库系统4/image-20241119000822948.png)

最终为

![image-20241119000924317](电商数仓项目-电商数据仓库系统4/image-20241119000924317.png)
...
![image-20241129175001005](电商数仓项目-电商数据仓库系统4/image-20241129175001005.png)
...
![image-20241129181633630](电商数仓项目-电商数据仓库系统4/image-20241129181633630.png)

![image-20241129181647562](电商数仓项目-电商数据仓库系统4/image-20241129181647562.png)

![image-20241129181659534](电商数仓项目-电商数据仓库系统4/image-20241129181659534.png)

![image-20241129181711257](电商数仓项目-电商数据仓库系统4/image-20241129181711257.png)
...
![image-20241129192036993](电商数仓项目-电商数据仓库系统4/image-20241129192036993.png)
...
![image-20241130003242519](电商数仓项目-电商数据仓库系统4/image-20241130003242519.png)
...
![image-20241130031524176](电商数仓项目-电商数据仓库系统4/image-20241130031524176.png)

**3）向DolphinScheduler资源中心上传工作流所需脚本**

**（1）创建文件夹**

![image-20241130031531787](电商数仓项目-电商数据仓库系统4/image-20241130031531787.png)

**（2）上传工作流所需脚本**

将工作流所需的所有脚本上传到资源中心scripts路径下，结果如下。

![image-20241130031539420](电商数仓项目-电商数据仓库系统4/image-20241130031539420.png)
...
![image-20241130031551262](电商数仓项目-电商数据仓库系统4/image-20241130031551262.png)

**（3）配置环境**

![image-20241130031602504](电商数仓项目-电商数据仓库系统4/image-20241130031602504.png)
...
![image-20241130031620547](电商数仓项目-电商数据仓库系统4/image-20241130031620547.png)

**（2）各任务节点配置如下**

①mysql_to_hdfs_full

![image-20241130031629225](电商数仓项目-电商数据仓库系统4/image-20241130031629225.png)

②hdfs_to_ods_db

![image-20241130031637566](电商数仓项目-电商数据仓库系统4/image-20241130031637566.png)

③hdfs_to_ods_log

![image-20241130031644481](电商数仓项目-电商数据仓库系统4/image-20241130031644481.png)

④ods_to_dwd

![image-20241130031649469](电商数仓项目-电商数据仓库系统4/image-20241130031649469.png)

⑤ods_to_dim

![image-20241130031654826](电商数仓项目-电商数据仓库系统4/image-20241130031654826.png)

⑥dwd_to_dws_1d

![image-20241130031700966](电商数仓项目-电商数据仓库系统4/image-20241130031700966.png)

⑦dws_1d_to_dws_nd

![image-20241130031706311](电商数仓项目-电商数据仓库系统4/image-20241130031706311.png)

⑧dws_1d_to_dws_td

![image-20241130031711915](电商数仓项目-电商数据仓库系统4/image-20241130031711915.png)

⑨dws_to_ads

![image-20241130031716907](电商数仓项目-电商数据仓库系统4/image-20241130031716907.png)

⑩hdfs_to_mysql

![image-20241130031721885](电商数仓项目-电商数据仓库系统4/image-20241130031721885.png)

**（3）各节点依赖关系如下**

![image-20241130031729144](电商数仓项目-电商数据仓库系统4/image-20241130031729144.png)

**（4）保存工作流**

![image-20241130031735853](电商数仓项目-电商数据仓库系统4/image-20241130031735853.png)

**注：定时调度时，全局参数值应设置为$[yyyy-MM-dd-1]或者空值。**

**7）上线工作流**

![image-20241130031740836](电商数仓项目-电商数据仓库系统4/image-20241130031740836.png)

**8）执行工作流**

![image-20241130031746408](电商数仓项目-电商数据仓库系统4/image-20241130031746408.png)
